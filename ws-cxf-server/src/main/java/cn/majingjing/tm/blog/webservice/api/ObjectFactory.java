...
public class ObjectFactory {
    ...
    private final static QName _Upload_QNAME = new QName("http://api.webservice.blog.tm.majingjing.cn/", "upload");
    private final static QName _DownloadResponse_QNAME = new QName("http://api.webservice.blog.tm.majingjing.cn/", "downloadResponse");
    private final static QName _Download_QNAME = new QName("http://api.webservice.blog.tm.majingjing.cn/", "download");
    private final static QName _UploadResponse_QNAME = new QName("http://api.webservice.blog.tm.majingjing.cn/", "uploadResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://api.webservice.blog.tm.majingjing.cn/", name = "upload")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://api.webservice.blog.tm.majingjing.cn/", name = "downloadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://api.webservice.blog.tm.majingjing.cn/", name = "download")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://api.webservice.blog.tm.majingjing.cn/", name = "uploadResponse")
